...
const HomeScreenPaginator = props => {
    const {parameters} = useSelector(state => state.listConfigs)
    ...
    const listPagesHandler = () => {
        ...
        let link = `/?searchKeyword=${props.params.searchKeyword ? props.params.searchKeyword : ''}&sortOrder=${props.params.sortOrder ? props.params.sortOrder : ''}&`
...
export default HomeScreenPaginator
